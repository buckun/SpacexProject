package com.buckun.spacexproject.ui.spacexrockets
...
import com.buckun.spacexproject.databinding.FragmentSpaceXRocketsBinding
...
class SpaceXRocketsFragment : BaseFragment<FragmentSpaceXRocketsBinding, SpaceXRocketViewModel>() {
    ...
    private fun addObservers() {
        viewModel?.getScreenLoading()?.observe(this, { show ->
            fragmentViewDataBinding?.progressSpaceXRockets?.pbActiveMoments?.visibility =
